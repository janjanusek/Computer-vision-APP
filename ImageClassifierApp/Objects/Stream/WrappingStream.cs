...
namespace ImageClassifierApp.Objects.Stream
{
    public class WrappingStream : System.IO.Stream
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WrappingStream"/> class.
        /// </summary>
        /// <param name="streamBase">The wrapped stream.</param>
        public WrappingStream(System.IO.Stream streamBase)
        {
            // check parameters
